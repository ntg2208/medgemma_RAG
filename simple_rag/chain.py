...
class SimpleRAGChain:
    ...
    def __init__(
        ...
        Args:
            ...
            system_prompt: System prompt for the LLM. Defaults to RAG_SYSTEM_PROMPT
                           personalised with patient context from personal_context.txt.
            prompt_template: Template for combining context and question
        """
        self.retriever = retriever
        self.llm = llm or MedGemmaLLM()
        self.system_prompt = system_prompt or build_system_prompt(load_patient_context())
...
def create_rag_chain(
    ...
    Args:
        ...
        use_tree: Whether to use tree-based retrieval (default: True)
        embedding_function: Required when use_tree=True
